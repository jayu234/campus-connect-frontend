        ...
        <Grid component={'div'} container direction={'column'}>
            <Grid item sx={{ border: '1px solid #e2e8f0cc', borderRadius: '0.5rem', backgroundColor: '#fff', marginBottom: '1rem', ":hover": { borderColor: '#cfcfcf' } }}>
                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', columnGap: '1rem', padding: '0.75rem' }}>
                    <Box mb={1} sx={{ width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center', columnGap: '0.5rem' }}>
                    ...
                    <Box sx={{ width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center', columnGap: '1rem' }}>
                        <Button onClick={() => { setTabInd(0); setOpen(true) }} fullWidth sx={{ borderRadius: '16px', padding: '0.5rem', textTransform: 'none' }} startIcon={<LiveHelpIcon />}>Ask</Button>
                        <Divider orientation="vertical" flexItem />
                        <Button fullWidth sx={{ borderRadius: '16px', padding: '0.5rem', textTransform: 'none' }} startIcon={<QuestionAnswerIcon />}>Answer</Button>
                        <Divider orientation="vertical" flexItem />
                        <Button onClick={() => { setTabInd(1); setOpen(true) }} fullWidth sx={{ borderRadius: '16px', padding: '0.5rem', textTransform: 'none' }} startIcon={<RateReviewIcon />}>Post</Button>
                    </Box>
                </Box>
